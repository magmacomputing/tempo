import type { Enum } from './lib/enumerate.library.js';
import type { OwnOf, KeyOf, ValueOf, LooseUnion, Mutable } from './lib/type.library.js';
/**
 ...
 */
/** */
export declare const WEEKDAY: Enum.wrap<import("./lib/type.library.js").Index<["All", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]>>;
export declare const WEEKDAYS: Enum.wrap<import("./lib/type.library.js").Index<["Everyday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]>>;
...
export declare const MONTH: Enum.wrap<import("./lib/type.library.js").Index<["All", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]>>;
export declare const MONTHS: Enum.wrap<import("./lib/type.library.js").Index<["Every", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]>>;
...
export declare const LIMIT: import("./lib/type.library.js").SecureObject<{
...
export declare const OPTION: Enum.wrap<import("./lib/type.library.js").Index<["value", "mdyLocales", "mdyLayouts", "store", "discovery", "debug", "catch", "timeZone", "calendar", "locale", "pivot", "sphere", "timeStamp", "snippet", "layout", "event", "period", "formats", "plugins"]>>;
export type Option = KeyOf<typeof OPTION>;
export declare const PARSE: Enum.wrap<import("./lib/type.library.js").Index<["mdyLocales", "mdyLayouts", "formats", "pivot", "snippet", "layout", "event", "period", "anchor", "value", "discovery", "plugins"]>>;
export type Parse = KeyOf<typeof PARSE>;
export declare const DISCOVERY: Enum.wrap<import("./lib/type.library.js").Index<["options", "timeZones", "terms", "plugins"]>>;
