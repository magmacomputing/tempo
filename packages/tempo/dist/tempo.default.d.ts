...
export declare const Token: import("./lib/type.library.js").Extend<{
 ...
 */
export declare const Snippet: import("./lib/type.library.js").Extend<{
 ...
 */
export declare const Layout: import("./lib/type.library.js").Extend<{
 ...
 */
export declare const Event: import("./lib/type.library.js").Extend<{
 ...
 */
export declare const Period: import("./lib/type.library.js").Extend<{
 ...
 */
export declare const TimeZone: import("./lib/type.library.js").Extend<{
    readonly utc: "UTC";
...
export declare const Default: import("./lib/type.library.js").SecureObject<Tempo.Options>;
