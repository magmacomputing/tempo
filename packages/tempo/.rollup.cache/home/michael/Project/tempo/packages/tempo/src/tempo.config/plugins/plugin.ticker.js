...
export const TickerPlugin = (_options, TempoClass, _factory) => {
     ...
     */
    TempoClass.ticker = function (intervalMs, seedOrCallback, callback) {
        ...
        const now = () => globalThis.Temporal.Now.instant().epochMilliseconds;
        // Pattern 2 ~ Callbacks
        if (isFunction(cb)) {
        ...
        return Object.assign(generator, {
            [Symbol.asyncDispose]: async () => { await generator.return(void 0); }
        });
    };
};
