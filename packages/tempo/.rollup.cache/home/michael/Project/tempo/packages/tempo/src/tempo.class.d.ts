...
export declare class Tempo {
    ...
    /** Time durations as milliseconds (plural) */ static get DURATIONS(): Enum.wrap<{
    ...
    /** Quarterly Seasons */ static get SEASON(): Enum.wrap<{
        readonly Summer: "summer";
        readonly Autumn: "autumn";
        readonly Winter: "winter";
        readonly Spring: "spring";
    }>;
    /** Compass cardinal points */ static get COMPASS(): Enum.wrap<{
        readonly North: "north";
        readonly East: "east";
        readonly South: "south";
        readonly West: "west";
    }>;
    /** Tempo to Temporal DateTime Units map */ static get ELEMENT(): Enum.wrap<{
        readonly yy: "year";
        readonly mm: "month";
        readonly ww: "week";
        readonly dd: "day";
 ...
 */
    static get options(): {
        default: import("#core/shared/type.library.js").SecureObject<{
            ...
            readonly calendar?: Temporal.CalendarLike;
            ...
            readonly snippet?: string | import("#core/shared/type.library.js").SecureObject<import("#core/shared/type.library.js").Extend<{
                ...
                readonly 
                /** create an object based on a prototype */ [Token.hh]: RegExp;
                ...
                readonly [Token
                    ...
                    */
                    .
                         ...
                         * because it will also include a list of periods (e.g. 'midnight' | 'afternoon' ), we need to rebuild {tm} if the user adds a new period
                        */
                        mdy]: "({wkd}{sep}+)?{mm}{sep}?{dd}({sep}?{yy})?{sfx}?{brk}?";
    ...
    /** 4-digit year (e.g., 2024) */ get yy(): any;
    /** 4-digit ISO week-numbering year */ get wy(): any;
    /** Month number: Jan=1, Dec=12 */ get mm(): Tempo.mm;
    /** ISO week number of the year */ get ww(): Tempo.ww;
    /** Day of the month (1-31) */ get dd(): any;
    /** Day of the month (alias for `dd`) */ get day(): any;
    ...
    /** IANA Time Zone ID (e.g., 'Australia/Sydney') */ get tz(): any;
    /** Unix timestamp (defaults to milliseconds) */ get ts(): any;
    ...
    /** Nanoseconds since Unix epoch (BigInt) */ get nano(): any;
    ...
    /** units since epoch */ get epoch(): import("#core/shared/type.library.js").SecureObject<{
        ...
        /** nanoseconds since epoch */ readonly ns: any;
    }>;
    ...
    /** applies a format to the instance. See `doc/tempo.md`. */ format<K extends enums.Format>(fmt: K): Tempo.FormatType<K>;
    ...
    /** returns the underlying Temporal.ZonedDateTime */ toDateTime(): any;
    /** returns a Temporal.PlainDate representation */ toPlainDate(): any;
    /** returns a Temporal.PlainTime representation */ toPlainTime(): any;
    /** returns a Temporal.PlainDateTime representation */ toPlainDateTime(): any;
    /** returns the underlying Temporal.Instant */ toInstant(): any;
    /** the date-time as a standard `Date` object. */ toDate(): Date;
    /** the ISO8601 string representation of the date-time. */ toString(): any;
